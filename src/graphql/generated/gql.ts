 ...
 */
type Documents = {
    "query getAllAgencies {\n  agencies {\n    id\n    name\n    slug\n    logo\n    theme\n  }\n}\n\nquery getAgencyBySlug($slug: String!) {\n  agency(slug: $slug) {\n    id\n    name\n    slug\n    theme\n    logo\n    members {\n      userId\n    }\n  }\n}\n\nmutation addAgency($data: AgencyInput!) {\n  agency: addAgency(data: $data) {\n    id\n    name\n    slug\n  }\n}\n\nmutation updateAgency($id: ID!, $data: AgencyInput!) {\n  agency: updateAgency(id: $id, data: $data) {\n    id\n    name\n    slug\n    theme\n  }\n}": typeof types.GetAllAgenciesDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query getAllAgencies {\n  agencies {\n    id\n    name\n    slug\n    logo\n    theme\n  }\n}\n\nquery getAgencyBySlug($slug: String!) {\n  agency(slug: $slug) {\n    id\n    name\n    slug\n    theme\n    logo\n    members {\n      userId\n    }\n  }\n}\n\nmutation addAgency($data: AgencyInput!) {\n  agency: addAgency(data: $data) {\n    id\n    name\n    slug\n  }\n}\n\nmutation updateAgency($id: ID!, $data: AgencyInput!) {\n  agency: updateAgency(id: $id, data: $data) {\n    id\n    name\n    slug\n    theme\n  }\n}"): (typeof documents)["query getAllAgencies {\n  agencies {\n    id\n    name\n    slug\n    logo\n    theme\n  }\n}\n\nquery getAgencyBySlug($slug: String!) {\n  agency(slug: $slug) {\n    id\n    name\n    slug\n    theme\n    logo\n    members {\n      userId\n    }\n  }\n}\n\nmutation addAgency($data: AgencyInput!) {\n  agency: addAgency(data: $data) {\n    id\n    name\n    slug\n  }\n}\n\nmutation updateAgency($id: ID!, $data: AgencyInput!) {\n  agency: updateAgency(id: $id, data: $data) {\n    id\n    name\n    slug\n    theme\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
